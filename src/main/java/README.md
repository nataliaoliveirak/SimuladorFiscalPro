# 📊 Simulador Fiscal Pro - MVA Ajustado & DIFAL
...
O grande diferencial deste projeto é a precisão no cálculo do **MVA Ajustado**, utilizando a fórmula:
`[(1 + MVA_Original) * (1 - Aliq_Inter) / (1 - Aliq_Int) - 1]`
